...
interface IIconOpenSearchProps {
  padding?: string;
}

const IconOpenSearch = (props: IIconOpenSearchProps) => {
  const padding: string = props.padding || "10px 0 0 0";
